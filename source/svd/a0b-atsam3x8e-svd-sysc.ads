...
package A0B.ATSAM3X8E.SVD.SYSC is
   pragma Preelaborate;
   ...
   type RSTC_CR_Register is record
      ...
      --  unspecified
      Reserved_4_23 : A0B.Types.SVD.UInt20 := 16#0#;
   ...
   subtype RSTC_MR_ERSTL_Field is A0B.Types.SVD.UInt4;
...
--  reads as 0.
   ...
   type RTC_CR_Register is record
      ...
      --  Time Event Selection
      TIMEVSEL       : CR_TIMEVSEL_Field := A0B.ATSAM3X8E.SVD.SYSC.MINUTE;
      --  unspecified
      Reserved_10_15 : A0B.Types.SVD.UInt6 := 16#0#;
      --  Calendar Event Selection
      CALEVSEL       : CR_CALEVSEL_Field := A0B.ATSAM3X8E.SVD.SYSC.WEEK;
      --  unspecified
   ...
   subtype RTC_TIMR_SEC_Field is A0B.Types.SVD.UInt7;
   subtype RTC_TIMR_MIN_Field is A0B.Types.SVD.UInt7;
   subtype RTC_TIMR_HOUR_Field is A0B.Types.SVD.UInt6;
   ...
   subtype RTC_CALR_CENT_Field is A0B.Types.SVD.UInt7;
   subtype RTC_CALR_YEAR_Field is A0B.Types.SVD.Byte;
   subtype RTC_CALR_MONTH_Field is A0B.Types.SVD.UInt5;
   subtype RTC_CALR_DAY_Field is A0B.Types.SVD.UInt3;
   subtype RTC_CALR_DATE_Field is A0B.Types.SVD.UInt6;
   ...
   subtype RTC_TIMALR_SEC_Field is A0B.Types.SVD.UInt7;
   subtype RTC_TIMALR_MIN_Field is A0B.Types.SVD.UInt7;
   subtype RTC_TIMALR_HOUR_Field is A0B.Types.SVD.UInt6;
   ...
   subtype RTC_CALALR_MONTH_Field is A0B.Types.SVD.UInt5;
   subtype RTC_CALALR_DATE_Field is A0B.Types.SVD.UInt6;
...
--  WPEN bit.Always reads as 0.
   ...
   subtype RTT_MR_RTPRES_Field is A0B.Types.SVD.UInt16;
...
--  output.
   ...
   type SUPC_CR_Register is record
      ...
      VROFF         : CR_VROFF_Field := A0B.ATSAM3X8E.SVD.SYSC.NO_EFFECT;
      --  Write-only. Crystal Oscillator Select
      XTALSEL       : CR_XTALSEL_Field := A0B.ATSAM3X8E.SVD.SYSC.NO_EFFECT;
      --  unspecified
      Reserved_4_23 : A0B.Types.SVD.UInt20 := 16#0#;
      --  Write-only. Password
      KEY           : CR_KEY_Field := CR_KEY_Field_Reset;
   ...
   subtype SUPC_SMMR_SMTH_Field is A0B.Types.SVD.UInt4;
...
--  occurs.
   ...
   type SUPC_SMMR_Register is record
      ...
      --  Supply Monitor Sampling Period
      SMSMPL         : SMMR_SMSMPL_Field := A0B.ATSAM3X8E.SVD.SYSC.SMD;
      --  unspecified
      Reserved_11_11 : A0B.Types.SVD.Bit := 16#0#;
      --  Supply Monitor Reset Enable
      SMRSTEN        : SMMR_SMRSTEN_Field :=
                        A0B.ATSAM3X8E.SVD.SYSC.NOT_ENABLE;
      --  Supply Monitor Interrupt Enable
      SMIEN          : SMMR_SMIEN_Field := A0B.ATSAM3X8E.SVD.SYSC.NOT_ENABLE;
      --  unspecified
...
--  are used)
   ...
   type SUPC_MR_Register is record
      --  unspecified
      Reserved_0_11  : A0B.Types.SVD.UInt12 := 16#A00#;
      --  Brownout Detector Reset Enable
      BODRSTEN       : MR_BODRSTEN_Field := A0B.ATSAM3X8E.SVD.SYSC.ENABLE;
      --  Brownout Detector Disable
      BODDIS         : MR_BODDIS_Field := A0B.ATSAM3X8E.SVD.SYSC.ENABLE;
      --  VDDIO Ready
      VDDIORDY       : MR_VDDIORDY_Field :=
                        A0B.ATSAM3X8E.SVD.SYSC.VDDIO_PRESENT;
      --  unspecified
      Reserved_15_19 : A0B.Types.SVD.UInt5 := 16#0#;
      --  Oscillator Bypass
      OSCBYPASS      : MR_OSCBYPASS_Field := A0B.ATSAM3X8E.SVD.SYSC.NO_EFFECT;
      --  unspecified
   ...
   type SUPC_WUMR_Register is record
      --  Force Wake-up Enable
      FWUPEN         : WUMR_FWUPEN_Field := A0B.ATSAM3X8E.SVD.SYSC.NOT_ENABLE;
      --  Supply Monitor Wake-up Enable
      SMEN           : WUMR_SMEN_Field := A0B.ATSAM3X8E.SVD.SYSC.NOT_ENABLE;
      --  Real Time Timer Wake-up Enable
      RTTEN          : WUMR_RTTEN_Field := A0B.ATSAM3X8E.SVD.SYSC.NOT_ENABLE;
      --  Real Time Clock Wake-up Enable
      RTCEN          : WUMR_RTCEN_Field := A0B.ATSAM3X8E.SVD.SYSC.NOT_ENABLE;
      --  unspecified
      Reserved_4_7   : A0B.Types.SVD.UInt4 := 16#0#;
      --  Force Wake-up Debouncer Period
      FWUPDBC        : WUMR_FWUPDBC_Field := A0B.ATSAM3X8E.SVD.SYSC.IMMEDIATE;
      --  unspecified
      Reserved_11_11 : A0B.Types.SVD.Bit := 16#0#;
      --  Wake-up Inputs Debouncer Period
      WKUPDBC        : WUMR_WKUPDBC_Field := A0B.ATSAM3X8E.SVD.SYSC.IMMEDIATE;
      --  unspecified
...
--  triggered a wake-up event.
   ...
   type WDT_CR_Register is record
      ...
      --  unspecified
      Reserved_1_23 : A0B.Types.SVD.UInt23 := 16#0#;
      --  Write-only. Password.
      KEY           : CR_KEY_Field := CR_KEY_Field_Reset;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype WDT_MR_WDV_Field is A0B.Types.SVD.UInt12;
   subtype WDT_MR_WDD_Field is A0B.Types.SVD.UInt12;
   ...
   type GPBR_Peripheral is record
      --  General Purpose Backup Register
      GPBR_0 : aliased A0B.Types.SVD.UInt32;
      --  General Purpose Backup Register
      GPBR_1 : aliased A0B.Types.SVD.UInt32;
      --  General Purpose Backup Register
      GPBR_2 : aliased A0B.Types.SVD.UInt32;
      --  General Purpose Backup Register
      GPBR_3 : aliased A0B.Types.SVD.UInt32;
      --  General Purpose Backup Register
      GPBR_4 : aliased A0B.Types.SVD.UInt32;
      --  General Purpose Backup Register
      GPBR_5 : aliased A0B.Types.SVD.UInt32;
      --  General Purpose Backup Register
      GPBR_6 : aliased A0B.Types.SVD.UInt32;
      --  General Purpose Backup Register
      GPBR_7 : aliased A0B.Types.SVD.UInt32;
   end record
     with Volatile;
   ...
   type RTT_Peripheral is record
      ...
      --  Value Register
      VR : aliased A0B.Types.SVD.UInt32;
      --  Status Register
