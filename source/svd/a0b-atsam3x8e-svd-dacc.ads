...
package A0B.ATSAM3X8E.SVD.DACC is
   pragma Preelaborate;
   ...
   subtype DACC_MR_TRGSEL_Field is A0B.Types.SVD.UInt3;
   ...
   subtype DACC_MR_REFRESH_Field is A0B.Types.SVD.Byte;
...
--  conversion.
   ...
   type DACC_MR_Register is record
      --  Trigger Enable
      TRGEN          : MR_TRGEN_Field := A0B.ATSAM3X8E.SVD.DACC.DIS;
      --  Trigger Selection
      TRGSEL         : DACC_MR_TRGSEL_Field := 16#0#;
      --  Word Transfer
      WORD           : MR_WORD_Field := A0B.ATSAM3X8E.SVD.DACC.HALF;
      --  Sleep Mode
      SLEEP          : Boolean := False;
      --  Fast Wake up Mode
      ...
      --  User Channel Selection
      USER_SEL       : MR_USER_SEL_Field := A0B.ATSAM3X8E.SVD.DACC.CHANNEL0;
      --  unspecified
      Reserved_18_19 : A0B.Types.SVD.UInt2 := 16#0#;
      --  Tag Selection Mode
      TAG            : MR_TAG_Field := A0B.ATSAM3X8E.SVD.DACC.DIS;
      --  Max Speed Mode
      MAXS           : MR_MAXS_Field := A0B.ATSAM3X8E.SVD.DACC.NORMAL;
      --  unspecified
      Reserved_22_23 : A0B.Types.SVD.UInt2 := 16#0#;
      --  Startup Time Selection
      STARTUP        : MR_STARTUP_Field := A0B.ATSAM3X8E.SVD.DACC.Val_0;
      --  unspecified
   ...
   subtype DACC_ACR_IBCTLCH_Element is A0B.Types.SVD.UInt2;
   ...
   subtype DACC_ACR_IBCTLDACCORE_Field is A0B.Types.SVD.UInt2;
   ...
   subtype DACC_WPMR_WPKEY_Field is A0B.Types.SVD.UInt24;
   ...
   subtype DACC_WPSR_WPROTADDR_Field is A0B.Types.SVD.Byte;
   ...
   subtype DACC_TCR_TXCTR_Field is A0B.Types.SVD.UInt16;
   ...
   subtype DACC_TNCR_TXNCTR_Field is A0B.Types.SVD.UInt16;
   ...
   type DACC_Peripheral is record
      ...
      CDR  : aliased A0B.Types.SVD.UInt32;
      --  Interrupt Enable Register
