...
--  Ethernet MAC 10/100
package A0B.ATSAM3X8E.SVD.EMAC is
   pragma Preelaborate;
   ...
   type EMAC_NCFGR_Register is record
      ...
      --  MDC clock divider
      CLK            : NCFGR_CLK_Field := A0B.ATSAM3X8E.SVD.EMAC.MCK_32;
      --  Retry test
      RTY            : Boolean := False;
      --  Pause Enable
      PAE            : Boolean := False;
      --  Receive Buffer Offset
      RBOF           : NCFGR_RBOF_Field := A0B.ATSAM3X8E.SVD.EMAC.OFFSET_0;
   ...
   subtype EMAC_RBQP_ADDR_Field is A0B.Types.SVD.UInt30;
   ...
   subtype EMAC_TBQP_ADDR_Field is A0B.Types.SVD.UInt30;
   ...
   type EMAC_IMR_Register is record
      ...
      TCOMP          : Boolean;
      --  unspecified
      Reserved_8_9   : A0B.Types.SVD.UInt2;
   ...
   subtype EMAC_MAN_DATA_Field is A0B.Types.SVD.UInt16;
   subtype EMAC_MAN_CODE_Field is A0B.Types.SVD.UInt2;
   subtype EMAC_MAN_REGA_Field is A0B.Types.SVD.UInt5;
   subtype EMAC_MAN_PHYA_Field is A0B.Types.SVD.UInt5;
   subtype EMAC_MAN_RW_Field is A0B.Types.SVD.UInt2;
   subtype EMAC_MAN_SOF_Field is A0B.Types.SVD.UInt2;
   ...
   subtype EMAC_PTR_PTIME_Field is A0B.Types.SVD.UInt16;
   ...
   subtype EMAC_PFR_FROK_Field is A0B.Types.SVD.UInt16;
   ...
   subtype EMAC_FTO_FTOK_Field is A0B.Types.SVD.UInt24;
   ...
   subtype EMAC_SCF_SCF_Field is A0B.Types.SVD.UInt16;
   ...
   subtype EMAC_MCF_MCF_Field is A0B.Types.SVD.UInt16;
   ...
   subtype EMAC_FRO_FROK_Field is A0B.Types.SVD.UInt24;
   ...
   subtype EMAC_FCSE_FCSE_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_ALE_ALE_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_DTF_DTF_Field is A0B.Types.SVD.UInt16;
   ...
   subtype EMAC_LCOL_LCOL_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_ECOL_EXCOL_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_TUND_TUND_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_CSE_CSE_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_RRE_RRE_Field is A0B.Types.SVD.UInt16;
   ...
   subtype EMAC_ROV_ROVR_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_RSE_RSE_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_ELE_EXL_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_RJA_RJB_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_USF_USF_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_STE_SQER_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_RLE_RLFM_Field is A0B.Types.SVD.Byte;
   ...
   subtype EMAC_SA1T_ADDR_Field is A0B.Types.SVD.UInt16;
   ...
   subtype EMAC_SA2T_ADDR_Field is A0B.Types.SVD.UInt16;
   ...
   subtype EMAC_SA3T_ADDR_Field is A0B.Types.SVD.UInt16;
   ...
   subtype EMAC_SA4T_ADDR_Field is A0B.Types.SVD.UInt16;
   ...
   subtype EMAC_TID_TID_Field is A0B.Types.SVD.UInt16;
