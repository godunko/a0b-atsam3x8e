...
package A0B.ATSAM3X8E.SVD.SPI is
   pragma Preelaborate;
   ...
   subtype SPI0_MR_PCS_Field is A0B.Types.SVD.UInt4;
   subtype SPI0_MR_DLYBCS_Field is A0B.Types.SVD.Byte;
   ...
   subtype SPI0_RDR_RD_Field is A0B.Types.SVD.UInt16;
   subtype SPI0_RDR_PCS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype SPI0_TDR_TD_Field is A0B.Types.SVD.UInt16;
   subtype SPI0_TDR_PCS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype SPI0_CSR_SCBR_Field is A0B.Types.SVD.Byte;
   subtype SPI0_CSR_DLYBS_Field is A0B.Types.SVD.Byte;
   subtype SPI0_CSR_DLYBCT_Field is A0B.Types.SVD.Byte;
   ...
   type SPI0_CSR_Register is record
      ...
      CSAAT  : Boolean := False;
      --  Bits Per Transfer
      BITS   : CSR_BITS_Field := A0B.ATSAM3X8E.SVD.SPI.Val_8_BIT;
...
--  WPEN bit.Always reads as 0.
   ...
   subtype SPI0_WPSR_WPVSRC_Field is A0B.Types.SVD.Byte;
