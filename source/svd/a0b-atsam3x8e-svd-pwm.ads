...
package A0B.ATSAM3X8E.SVD.PWM is
   ...
   subtype PWM_CLK_DIVA_Field is A0B.Types.SVD.Byte;
   subtype PWM_CLK_PREA_Field is A0B.Types.SVD.UInt4;
   subtype PWM_CLK_DIVB_Field is A0B.Types.SVD.Byte;
   subtype PWM_CLK_PREB_Field is A0B.Types.SVD.UInt4;
   ...
   --  PWM_ENA_CHID array
   type PWM_ENA_CHID_Field_Array is array (0 .. 7) of Boolean
   ...
   --  PWM_DIS_CHID array
   type PWM_DIS_CHID_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_SR_CHID array
   type PWM_SR_CHID_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_IER1_CHID array
   type PWM_IER1_CHID_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type PWM_IER1_FCHID_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_IDR1_CHID array
   type PWM_IDR1_CHID_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type PWM_IDR1_FCHID_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_IMR1_CHID array
   type PWM_IMR1_CHID_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type PWM_IMR1_FCHID_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type PWM_IMR1_Register is record
      ...
      --  unspecified
      Reserved_8_15  : A0B.Types.SVD.Byte;
   ...
   --  PWM_ISR1_CHID array
   type PWM_ISR1_CHID_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type PWM_ISR1_FCHID_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_SCM_SYNC array
   type PWM_SCM_SYNC_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
...
--  update of synchronous channels
   ...
   subtype PWM_SCM_PTRCS_Field is A0B.Types.SVD.UInt3;
   ...
   type PWM_SCM_Register is record
      ...
      Reserved_8_15  : A0B.Types.SVD.Byte := 16#0#;
      --  Synchronous Channels Update Mode
      UPDM           : SCM_UPDM_Field := A0B.ATSAM3X8E.SVD.PWM.MODE0;
      --  unspecified
   ...
   subtype PWM_SCUP_UPR_Field is A0B.Types.SVD.UInt4;
   subtype PWM_SCUP_UPRCNT_Field is A0B.Types.SVD.UInt4;
   ...
   subtype PWM_SCUPUPD_UPRUPD_Field is A0B.Types.SVD.UInt4;
   ...
   --  PWM_OOV_OOVH array
   type PWM_OOV_OOVH_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_OOV_OOVL array
   type PWM_OOV_OOVL_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_OS_OSH array
   type PWM_OS_OSH_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_OS_OSL array
   type PWM_OS_OSL_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_OSS_OSSH array
   type PWM_OSS_OSSH_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_OSS_OSSL array
   type PWM_OSS_OSSL_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_OSC_OSCH array
   type PWM_OSC_OSCH_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_OSC_OSCL array
   type PWM_OSC_OSCL_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type PWM_OSSUPD_OSSUPH_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type PWM_OSSUPD_OSSUPL_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type PWM_OSCUPD_OSCUPH_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type PWM_OSCUPD_OSCUPL_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   for PWM_OSCUPD_Register use record
      ...
      Reserved_8_15  at 0 range 8 .. 15;
      OSCUPL         at 0 range 16 .. 23;
      Reserved_24_31 at 0 range 24 .. 31;
   end record;

   subtype PWM_FMR_FPOL_Field is A0B.Types.SVD.Byte;
   subtype PWM_FMR_FMOD_Field is A0B.Types.SVD.Byte;
   subtype PWM_FMR_FFIL_Field is A0B.Types.SVD.Byte;
   ...
   subtype PWM_FSR_FIV_Field is A0B.Types.SVD.Byte;
   subtype PWM_FSR_FS_Field is A0B.Types.SVD.Byte;
   ...
   subtype PWM_FCR_FCLR_Field is A0B.Types.SVD.Byte;
   ...
   --  PWM_FPV_FPVH array
   type PWM_FPV_FPVH_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  PWM_FPV_FPVL array
   type PWM_FPV_FPVL_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   subtype PWM_FPE1_FPE_Element is A0B.Types.SVD.Byte;
   ...
   subtype PWM_FPE2_FPE_Element is A0B.Types.SVD.Byte;
   ...
   --  PWM_SMMR_GCEN array
   type PWM_SMMR_GCEN_Field_Array is array (0 .. 3) of Boolean
   ...
   --  PWM_SMMR_DOWN array
   type PWM_SMMR_DOWN_Field_Array is array (0 .. 3) of Boolean
     with Component_Size => 1, Size => 4;
   ...
   subtype PWM_WPCR_WPCMD_Field is A0B.Types.SVD.UInt2;
   ...
   subtype PWM_WPCR_WPKEY_Field is A0B.Types.SVD.UInt24;
   ...
   subtype PWM_WPSR_WPVSRC_Field is A0B.Types.SVD.UInt16;
   ...
   type PWM_WPSR_Register is record
      ...
      --  unspecified
      Reserved_6_6   : A0B.Types.SVD.Bit;
   ...
   subtype PWM_TCR_TXCTR_Field is A0B.Types.SVD.UInt16;
   ...
   subtype PWM_TNCR_TXNCTR_Field is A0B.Types.SVD.UInt16;
   ...
   subtype CMPV_CV_Field is A0B.Types.SVD.UInt24;
   ...
   subtype CMPVUPD_CVUPD_Field is A0B.Types.SVD.UInt24;
   ...
   subtype CMPM_CTR_Field is A0B.Types.SVD.UInt4;
   subtype CMPM_CPR_Field is A0B.Types.SVD.UInt4;
   subtype CMPM_CPRCNT_Field is A0B.Types.SVD.UInt4;
   subtype CMPM_CUPR_Field is A0B.Types.SVD.UInt4;
   subtype CMPM_CUPRCNT_Field is A0B.Types.SVD.UInt4;
   ...
   subtype CMPMUPD_CTRUPD_Field is A0B.Types.SVD.UInt4;
   subtype CMPMUPD_CPRUPD_Field is A0B.Types.SVD.UInt4;
   subtype CMPMUPD_CUPRUPD_Field is A0B.Types.SVD.UInt4;
   ...
   type CMR_Register is record
      --  Channel Pre-scaler
      CPRE           : CMR0_CPRE_Field := A0B.ATSAM3X8E.SVD.PWM.MCK;
      --  unspecified
      Reserved_4_7   : A0B.Types.SVD.UInt4 := 16#0#;
      --  Channel Alignment
      CALG           : Boolean := False;
   ...
   subtype CDTY_CDTY_Field is A0B.Types.SVD.UInt24;
   ...
   subtype CDTYUPD_CDTYUPD_Field is A0B.Types.SVD.UInt24;
   ...
   subtype CPRD_CPRD_Field is A0B.Types.SVD.UInt24;
   ...
   subtype CPRDUPD_CPRDUPD_Field is A0B.Types.SVD.UInt24;
   ...
   subtype CCNT_CNT_Field is A0B.Types.SVD.UInt24;
   ...
   subtype DT_DTH_Field is A0B.Types.SVD.UInt16;
   subtype DT_DTL_Field is A0B.Types.SVD.UInt16;
   ...
   subtype DTUPD_DTHUPD_Field is A0B.Types.SVD.UInt16;
   subtype DTUPD_DTLUPD_Field is A0B.Types.SVD.UInt16;
