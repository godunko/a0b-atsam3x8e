...
package A0B.ATSAM3X8E.SVD.CAN is
   pragma Preelaborate;
...
--  Edge)
   ...
   type CAN0_MR_Register is record
      ...
      DRPT           : Boolean := False;
      --  unspecified
      Reserved_8_23  : A0B.Types.SVD.UInt16 := 16#0#;
      --  Reception Synchronization Stage (not readable)
      RXSYNC         : MR_RXSYNC_Field := A0B.ATSAM3X8E.SVD.CAN.DOUBLE_PP;
      --  unspecified
   ...
   subtype CAN0_BR_PHASE2_Field is A0B.Types.SVD.UInt3;
   subtype CAN0_BR_PHASE1_Field is A0B.Types.SVD.UInt3;
   subtype CAN0_BR_PROPAG_Field is A0B.Types.SVD.UInt3;
   subtype CAN0_BR_SJW_Field is A0B.Types.SVD.UInt2;
   subtype CAN0_BR_BRP_Field is A0B.Types.SVD.UInt7;
...
--  period, centered on sample point.
   ...
   type CAN0_BR_Register is record
      ...
      --  Sampling Mode
      SMP            : BR_SMP_Field := A0B.ATSAM3X8E.SVD.CAN.ONCE;
      --  unspecified
   ...
   subtype CAN0_TIM_TIMER_Field is A0B.Types.SVD.UInt16;
   ...
   subtype CAN0_TIMESTP_MTIMESTAMP_Field is A0B.Types.SVD.UInt16;
   ...
   subtype CAN0_ECR_REC_Field is A0B.Types.SVD.Byte;
   subtype CAN0_ECR_TEC_Field is A0B.Types.SVD.Byte;
   ...
   type CAN0_TCR_Register is record
      ...
      --  unspecified
      Reserved_8_30 : A0B.Types.SVD.UInt23 := 16#0#;
   ...
   subtype CAN0_WPMR_WPKEY_Field is A0B.Types.SVD.UInt24;
   ...
   subtype CAN0_WPSR_WPVSRC_Field is A0B.Types.SVD.Byte;
   ...
   subtype MMR_MTIMEMARK_Field is A0B.Types.SVD.UInt16;
   subtype MMR_PRIOR_Field is A0B.Types.SVD.UInt4;
...
--  sending its contents.
   ...
   type MMR_Register is record
      ...
      --  Mailbox Object Type
      MOT            : MMR0_MOT_Field := A0B.ATSAM3X8E.SVD.CAN.MB_DISABLED;
      --  unspecified
      Reserved_27_31 : A0B.Types.SVD.UInt5 := 16#0#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype MAM_MIDvB_Field is A0B.Types.SVD.UInt18;
   subtype MAM_MIDvA_Field is A0B.Types.SVD.UInt11;
   ...
   subtype MID_MIDvB_Field is A0B.Types.SVD.UInt18;
   subtype MID_MIDvA_Field is A0B.Types.SVD.UInt11;
   ...
   subtype MFID_MFID_Field is A0B.Types.SVD.UInt29;
   ...
   subtype MSR_MTIMESTAMP_Field is A0B.Types.SVD.UInt16;
   subtype MSR_MDLC_Field is A0B.Types.SVD.UInt4;
   ...
   type MSR_Register is record
      ...
      MRTR           : Boolean;
      --  unspecified
      Reserved_21_21 : A0B.Types.SVD.Bit;
   ...
   subtype MCR_MDLC_Field is A0B.Types.SVD.UInt4;
   ...
   type CAN_Peripheral is record
      ...
      MDL0    : aliased A0B.Types.SVD.UInt32;
      --  Mailbox Data High Register (MB = 0)
      MDH0    : aliased A0B.Types.SVD.UInt32;
      --  Mailbox Control Register (MB = 0)
      ...
      MDL1    : aliased A0B.Types.SVD.UInt32;
      --  Mailbox Data High Register (MB = 1)
      MDH1    : aliased A0B.Types.SVD.UInt32;
      ...
      MDL2    : aliased A0B.Types.SVD.UInt32;
      --  Mailbox Data High Register (MB = 2)
      MDH2    : aliased A0B.Types.SVD.UInt32;
      ...
      MDL3    : aliased A0B.Types.SVD.UInt32;
      --  Mailbox Data High Register (MB = 3)
      MDH3    : aliased A0B.Types.SVD.UInt32;
      ...
      MDL4    : aliased A0B.Types.SVD.UInt32;
      --  Mailbox Data High Register (MB = 4)
      MDH4    : aliased A0B.Types.SVD.UInt32;
      ...
      MDL5    : aliased A0B.Types.SVD.UInt32;
      --  Mailbox Data High Register (MB = 5)
      MDH5    : aliased A0B.Types.SVD.UInt32;
      ...
      MDL6    : aliased A0B.Types.SVD.UInt32;
      --  Mailbox Data High Register (MB = 6)
      MDH6    : aliased A0B.Types.SVD.UInt32;
      ...
      MDL7    : aliased A0B.Types.SVD.UInt32;
      --  Mailbox Data High Register (MB = 7)
      MDH7    : aliased A0B.Types.SVD.UInt32;
