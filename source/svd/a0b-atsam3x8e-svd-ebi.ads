...
package A0B.ATSAM3X8E.SVD.EBI is
   pragma Preelaborate;
   ...
   subtype SMC_CFG_DTOCYC_Field is A0B.Types.SVD.UInt4;
   ...
   type SMC_CFG_Register is record
      --  Page Size of the NAND Flash Device
      PAGESIZE       : CFG_PAGESIZE_Field := A0B.ATSAM3X8E.SVD.EBI.PS512;
      --  unspecified
      ...
      --  Data Timeout Multiplier
      DTOMUL         : CFG_DTOMUL_Field := A0B.ATSAM3X8E.SVD.EBI.X1;
      --  unspecified
   ...
   subtype SMC_SR_NFCSID_Field is A0B.Types.SVD.UInt3;
   ...
   type SMC_SR_Register is record
      ...
      SMCSTS         : Boolean;
      --  unspecified
      Reserved_1_3   : A0B.Types.SVD.UInt3;
      ...
      NFCBUSY        : Boolean;
      --  unspecified
      Reserved_9_10  : A0B.Types.SVD.UInt2;
      ...
      CMDDONE        : Boolean;
      --  unspecified
      Reserved_18_19 : A0B.Types.SVD.UInt2;
   ...
   type SMC_IER_Register is record
      ...
      --  unspecified
      Reserved_6_15  : A0B.Types.SVD.UInt10 := 16#0#;
   ...
   subtype SMC_ADDR_ADDR_CYCLE0_Field is A0B.Types.SVD.Byte;
   ...
   subtype SMC_BANK_BANK_Field is A0B.Types.SVD.UInt3;
...
--  (for 8-bit NAND Flash only)
   ...
   type SMC_ECC_MD_Register is record
      ...
      ECC_PAGESIZE  : ECC_MD_ECC_PAGESIZE_Field :=
                       A0B.ATSAM3X8E.SVD.EBI.PS512;
      --  unspecified
      Reserved_2_3  : A0B.Types.SVD.UInt2 := 16#0#;
      --  Type of Correction
      TYPCORREC     : ECC_MD_TYPCORREC_Field := A0B.ATSAM3X8E.SVD.EBI.CPAGE;
      --  unspecified
   ...
   type SMC_ECC_SR1_Register is record
      ...
      ECCERR4        : Boolean;
      --  Read-only. Multiple Error in the page between the 1024th and the
      --  1279th bytes or between the 2048th and the 2559th bytes
      MULERR4        : Boolean;
      --  unspecified
      ...
      ECCERR5        : Boolean;
      --  Read-only. Multiple Error in the page between the 1280th and the
      --  1535th bytes or between the 2560th and the 3071st bytes
      MULERR5        : Boolean;
      --  unspecified
      Reserved_23_23 : A0B.Types.SVD.Bit;
      ...
      ECCERR6        : Boolean;
      --  Read-only. Multiple Error in the page between the 1536th and the
      --  1791st bytes or between the 3072nd and the 3583rd bytes
      MULERR6        : Boolean;
      --  unspecified
      ...
      ECCERR7        : Boolean;
      --  Read-only. Multiple Error in the page between the 1792nd and the
      --  2047th bytes or between the 3584th and the 4095th bytes
      MULERR7        : Boolean;
      --  unspecified
   ...
   for SMC_ECC_SR1_Register use record
      ...
      ECCERR0        at 0 range 1 .. 1;
      MULERR0        at 0 range 2 .. 2;
      ...
      ECCERR4        at 0 range 17 .. 17;
      MULERR4        at 0 range 18 .. 18;
      Reserved_19_19 at 0 range 19 .. 19;
      RECERR5        at 0 range 20 .. 20;
      ECCERR5        at 0 range 21 .. 21;
      MULERR5        at 0 range 22 .. 22;
      Reserved_23_23 at 0 range 23 .. 23;
      RECERR6        at 0 range 24 .. 24;
      ECCERR6        at 0 range 25 .. 25;
      MULERR6        at 0 range 26 .. 26;
      Reserved_27_27 at 0 range 27 .. 27;
      RECERR7        at 0 range 28 .. 28;
      ECCERR7        at 0 range 29 .. 29;
      MULERR7        at 0 range 30 .. 30;
      Reserved_31_31 at 0 range 31 .. 31;
   end record;

   subtype SMC_ECC_PR0_BITADDR_Field is A0B.Types.SVD.UInt4;
   subtype SMC_ECC_PR0_WORDADDR_Field is A0B.Types.SVD.UInt12;
   ...
   subtype SMC_ECC_PR0_W9BIT_BITADDR_Field is A0B.Types.SVD.UInt3;
   subtype SMC_ECC_PR0_W9BIT_WORDADDR_Field is A0B.Types.SVD.UInt9;
   subtype SMC_ECC_PR0_W9BIT_NPARITY_Field is A0B.Types.SVD.UInt12;
   ...
   subtype SMC_ECC_PR0_W8BIT_BITADDR_Field is A0B.Types.SVD.UInt3;
   subtype SMC_ECC_PR0_W8BIT_WORDADDR_Field is A0B.Types.SVD.Byte;
   subtype SMC_ECC_PR0_W8BIT_NPARITY_Field is A0B.Types.SVD.UInt11;
   ...
   subtype SMC_ECC_PR1_NPARITY_Field is A0B.Types.SVD.UInt16;
   ...
   subtype SMC_ECC_PR1_W9BIT_BITADDR_Field is A0B.Types.SVD.UInt3;
   subtype SMC_ECC_PR1_W9BIT_WORDADDR_Field is A0B.Types.SVD.UInt9;
   subtype SMC_ECC_PR1_W9BIT_NPARITY_Field is A0B.Types.SVD.UInt12;
   ...
   subtype SMC_ECC_PR1_W8BIT_BITADDR_Field is A0B.Types.SVD.UInt3;
   subtype SMC_ECC_PR1_W8BIT_WORDADDR_Field is A0B.Types.SVD.Byte;
   subtype SMC_ECC_PR1_W8BIT_NPARITY_Field is A0B.Types.SVD.UInt11;
   ...
   type SMC_ECC_SR2_Register is record
      ...
      --  bytes
      ECCERR8        : Boolean;
      --  Read-only. Multiple Error in the page between the 2048th and the
      --  2303rd bytes
      MULERR8        : Boolean;
      --  unspecified
      Reserved_3_3   : A0B.Types.SVD.Bit;
      ...
      --  bytes
      ECCERR12       : Boolean;
      --  Read-only. Multiple Error in the page between the 3072nd and the
      --  3327th bytes
      MULERR12       : Boolean;
      --  unspecified
      Reserved_19_19 : A0B.Types.SVD.Bit;
      ...
      --  bytes
      ECCERR13       : Boolean;
      --  Read-only. Multiple Error in the page between the 3328th and the
      --  3583rd bytes
      MULERR13       : Boolean;
      --  unspecified
      Reserved_23_23 : A0B.Types.SVD.Bit;
      ...
      --  bytes
      ECCERR14       : Boolean;
      --  Read-only. Multiple Error in the page between the 3584th and the
      --  3839th bytes
      MULERR14       : Boolean;
      --  unspecified
      Reserved_27_27 : A0B.Types.SVD.Bit;
      ...
      --  bytes
      ECCERR15       : Boolean;
      --  Read-only. Multiple Error in the page between the 3840th and the
      --  4095th bytes
      MULERR15       : Boolean;
      --  unspecified
      Reserved_31_31 : A0B.Types.SVD.Bit;
   ...
   for SMC_ECC_SR2_Register use record
      ...
      ECCERR8        at 0 range 1 .. 1;
      MULERR8        at 0 range 2 .. 2;
      Reserved_3_3   at 0 range 3 .. 3;
      ...
      ECCERR12       at 0 range 17 .. 17;
      MULERR12       at 0 range 18 .. 18;
      Reserved_19_19 at 0 range 19 .. 19;
      RECERR13       at 0 range 20 .. 20;
      ECCERR13       at 0 range 21 .. 21;
      MULERR13       at 0 range 22 .. 22;
      Reserved_23_23 at 0 range 23 .. 23;
      RECERR14       at 0 range 24 .. 24;
      ECCERR14       at 0 range 25 .. 25;
      MULERR14       at 0 range 26 .. 26;
      Reserved_27_27 at 0 range 27 .. 27;
      RECERR15       at 0 range 28 .. 28;
      ECCERR15       at 0 range 29 .. 29;
      MULERR15       at 0 range 30 .. 30;
      Reserved_31_31 at 0 range 31 .. 31;
   end record;

   subtype ECC_PR_BITADDR_Field is A0B.Types.SVD.UInt3;
   subtype ECC_PR_WORDADDR_Field is A0B.Types.SVD.UInt9;
   subtype ECC_PR_NPARITY_Field is A0B.Types.SVD.UInt12;
   ...
   subtype SMC_ECC_PR2_W8BIT_BITADDR_Field is A0B.Types.SVD.UInt3;
   subtype SMC_ECC_PR2_W8BIT_WORDADDR_Field is A0B.Types.SVD.Byte;
   subtype SMC_ECC_PR2_W8BIT_NPARITY_Field is A0B.Types.SVD.UInt11;
   ...
   subtype SMC_ECC_PR3_W8BIT_BITADDR_Field is A0B.Types.SVD.UInt3;
   subtype SMC_ECC_PR3_W8BIT_WORDADDR_Field is A0B.Types.SVD.Byte;
   subtype SMC_ECC_PR3_W8BIT_NPARITY_Field is A0B.Types.SVD.UInt11;
   ...
   subtype SMC_ECC_PR4_W8BIT_BITADDR_Field is A0B.Types.SVD.UInt3;
   subtype SMC_ECC_PR4_W8BIT_WORDADDR_Field is A0B.Types.SVD.Byte;
   subtype SMC_ECC_PR4_W8BIT_NPARITY_Field is A0B.Types.SVD.UInt11;
   ...
   subtype SMC_ECC_PR5_W8BIT_BITADDR_Field is A0B.Types.SVD.UInt3;
   subtype SMC_ECC_PR5_W8BIT_WORDADDR_Field is A0B.Types.SVD.Byte;
   subtype SMC_ECC_PR5_W8BIT_NPARITY_Field is A0B.Types.SVD.UInt11;
   ...
   subtype SMC_ECC_PR6_W8BIT_BITADDR_Field is A0B.Types.SVD.UInt3;
   subtype SMC_ECC_PR6_W8BIT_WORDADDR_Field is A0B.Types.SVD.Byte;
   subtype SMC_ECC_PR6_W8BIT_NPARITY_Field is A0B.Types.SVD.UInt11;
   ...
   subtype SMC_ECC_PR7_W8BIT_BITADDR_Field is A0B.Types.SVD.UInt3;
   subtype SMC_ECC_PR7_W8BIT_WORDADDR_Field is A0B.Types.SVD.Byte;
   subtype SMC_ECC_PR7_W8BIT_NPARITY_Field is A0B.Types.SVD.UInt11;
   ...
   subtype ECC_PR_WORDADDR_Field_1 is A0B.Types.SVD.Byte;
   subtype ECC_PR_NPARITY_Field_1 is A0B.Types.SVD.UInt11;
   ...
   subtype SETUP_NWE_SETUP_Field is A0B.Types.SVD.UInt6;
   subtype SETUP_NCS_WR_SETUP_Field is A0B.Types.SVD.UInt6;
   subtype SETUP_NRD_SETUP_Field is A0B.Types.SVD.UInt6;
   subtype SETUP_NCS_RD_SETUP_Field is A0B.Types.SVD.UInt6;
   ...
   subtype PULSE_NWE_PULSE_Field is A0B.Types.SVD.UInt7;
   subtype PULSE_NCS_WR_PULSE_Field is A0B.Types.SVD.UInt7;
   subtype PULSE_NRD_PULSE_Field is A0B.Types.SVD.UInt7;
   subtype PULSE_NCS_RD_PULSE_Field is A0B.Types.SVD.UInt7;
   ...
   subtype CYCLE_NWE_CYCLE_Field is A0B.Types.SVD.UInt9;
   subtype CYCLE_NRD_CYCLE_Field is A0B.Types.SVD.UInt9;
   ...
   subtype TIMINGS_TCLR_Field is A0B.Types.SVD.UInt4;
   subtype TIMINGS_TADL_Field is A0B.Types.SVD.UInt4;
   subtype TIMINGS_TAR_Field is A0B.Types.SVD.UInt4;
   subtype TIMINGS_TRR_Field is A0B.Types.SVD.UInt4;
   subtype TIMINGS_TWB_Field is A0B.Types.SVD.UInt4;
   subtype TIMINGS_RBNSEL_Field is A0B.Types.SVD.UInt3;
   ...
   subtype MODE_TDF_CYCLES_Field is A0B.Types.SVD.UInt4;

   --  SMC Mode Register (CS_number = 0)
   type MODE_Register is record
      --  Selection of the Control Signal for Read Operation
      READ_MODE      : MODE0_READ_MODE_Field :=
                        A0B.ATSAM3X8E.SVD.EBI.NRD_CTRL;
      --  Selection of the Control Signal for Write Operation
      WRITE_MODE     : MODE0_WRITE_MODE_Field :=
                        A0B.ATSAM3X8E.SVD.EBI.NWE_CTRL;
      --  unspecified
      Reserved_2_3   : A0B.Types.SVD.UInt2 := 16#0#;
      --  NWAIT Mode
      EXNW_MODE      : MODE0_EXNW_MODE_Field :=
                        A0B.ATSAM3X8E.SVD.EBI.DISABLED;
      --  unspecified
      Reserved_6_7   : A0B.Types.SVD.UInt2 := 16#0#;
      --  Byte Access Type
      BAT            : Boolean := False;
      ...
      --  Data Bus Width
      DBW            : MODE0_DBW_Field := A0B.ATSAM3X8E.SVD.EBI.BIT_8;
      --  unspecified
      Reserved_13_15 : A0B.Types.SVD.UInt3 := 16#0#;
      --  Data Float Time
      ...
      --  unspecified
      Reserved_21_31 : A0B.Types.SVD.UInt11 := 16#80#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type WPCR_WP_KEY_Field is
     (--  Reset value for the field
      WPCR_WP_KEY_Field_Reset,
      --  Writing any other value in this field aborts the write operation of the
--  WP_EN bit. Always reads as 0.
      PASSWD)
     with Size => 24;
   for WPCR_WP_KEY_Field use
     (WPCR_WP_KEY_Field_Reset => 0,
      PASSWD => 5459267);
   ...
   type SMC_WPCR_Register is record
      ...
      WP_KEY       : WPCR_WP_KEY_Field := WPCR_WP_KEY_Field_Reset;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype SMC_WPSR_WP_VS_Field is A0B.Types.SVD.UInt4;
   subtype SMC_WPSR_WP_VSRC_Field is A0B.Types.SVD.UInt16;
   ...
   is record
      ...
      KEY1          : aliased A0B.Types.SVD.UInt32;
      --  SMC OCMS KEY2 Register
      KEY2          : aliased A0B.Types.SVD.UInt32;
      --  Write Protection Control Register
