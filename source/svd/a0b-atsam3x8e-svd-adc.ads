...
package A0B.ATSAM3X8E.SVD.ADC is
   pragma Preelaborate;
...
--  between conversions and ADC Core is OFF
   ...
   subtype ADC_MR_PRESCAL_Field is A0B.Types.SVD.Byte;
...
--  Registers
   ...
   subtype ADC_MR_TRACKTIM_Field is A0B.Types.SVD.UInt4;
   subtype ADC_MR_TRANSFER_Field is A0B.Types.SVD.UInt2;
...
--  channel.
   ...
   type ADC_MR_Register is record
      --  Trigger Enable
      TRGEN          : MR_TRGEN_Field := A0B.ATSAM3X8E.SVD.ADC.DIS;
      --  Trigger Selection
      TRGSEL         : MR_TRGSEL_Field := A0B.ATSAM3X8E.SVD.ADC.ADC_TRIG0;
      --  unspecified
      Reserved_4_4   : A0B.Types.SVD.Bit := 16#0#;
      --  Sleep Mode
      SLEEP          : MR_SLEEP_Field := A0B.ATSAM3X8E.SVD.ADC.NORMAL;
      --  Fast Wake Up
      FWUP           : MR_FWUP_Field := A0B.ATSAM3X8E.SVD.ADC.OFF;
      --  Free Run Mode
      FREERUN        : MR_FREERUN_Field := A0B.ATSAM3X8E.SVD.ADC.OFF;
      --  Prescaler Rate Selection
      PRESCAL        : ADC_MR_PRESCAL_Field := 16#0#;
      --  Start Up Time
      STARTUP        : MR_STARTUP_Field := A0B.ATSAM3X8E.SVD.ADC.SUT0;
      --  Analog Settling Time
      SETTLING       : MR_SETTLING_Field := A0B.ATSAM3X8E.SVD.ADC.AST3;
      --  unspecified
      Reserved_22_22 : A0B.Types.SVD.Bit := 16#0#;
      --  Analog Change
      ANACH          : MR_ANACH_Field := A0B.ATSAM3X8E.SVD.ADC.NONE;
      --  Tracking Time
      ...
      --  Use Sequence Enable
      USEQ           : MR_USEQ_Field := A0B.ATSAM3X8E.SVD.ADC.NUM_ORDER;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype ADC_SEQR1_USCH_Element is A0B.Types.SVD.UInt4;
   ...
   subtype ADC_SEQR2_USCH_Element is A0B.Types.SVD.UInt4;
   ...
   subtype ADC_LCDR_LDATA_Field is A0B.Types.SVD.UInt12;
   subtype ADC_LCDR_CHNB_Field is A0B.Types.SVD.UInt4;
   ...
   type ADC_IMR_Register is record
      ...
      --  unspecified
      Reserved_16_23 : A0B.Types.SVD.Byte;
...
--  threshold of the window.
   ...
   subtype ADC_EMR_CMPSEL_Field is A0B.Types.SVD.UInt4;
   subtype ADC_EMR_CMPFILTER_Field is A0B.Types.SVD.UInt2;

   --  Extended Mode Register
   type ADC_EMR_Register is record
      --  Comparison Mode
      CMPMODE        : EMR_CMPMODE_Field := A0B.ATSAM3X8E.SVD.ADC.LOW;
      --  unspecified
   ...
   subtype ADC_CWR_LOWTHRES_Field is A0B.Types.SVD.UInt12;
   subtype ADC_CWR_HIGHTHRES_Field is A0B.Types.SVD.UInt12;
   ...
   subtype ADC_CGR_GAIN_Element is A0B.Types.SVD.UInt2;
   ...
   subtype ADC_CDR_DATA_Field is A0B.Types.SVD.UInt12;
   ...
   subtype ADC_ACR_IBCTL_Field is A0B.Types.SVD.UInt2;
...
--  WPEN bit.Always reads as 0
   ...
   subtype ADC_WPSR_WPVSRC_Field is A0B.Types.SVD.UInt16;
   ...
   subtype ADC_RCR_RXCTR_Field is A0B.Types.SVD.UInt16;
   ...
   subtype ADC_RNCR_RXNCTR_Field is A0B.Types.SVD.UInt16;
