...
--  AHB Bus Matrix
package A0B.ATSAM3X8E.SVD.MATRIX is
   pragma Preelaborate;
   ...
   subtype MATRIX_MCFG_ULBT_Field is A0B.Types.SVD.UInt3;
   ...
   subtype MATRIX_SCFG_SLOT_CYCLE_Field is A0B.Types.SVD.Byte;
   subtype MATRIX_SCFG_DEFMSTR_TYPE_Field is A0B.Types.SVD.UInt2;
   subtype MATRIX_SCFG_FIXED_DEFMSTR_Field is A0B.Types.SVD.UInt3;
   subtype MATRIX_SCFG_ARBT_Field is A0B.Types.SVD.UInt2;
   ...
   subtype MATRIX_PRAS_M0PR_Field is A0B.Types.SVD.UInt2;
   subtype MATRIX_PRAS_M1PR_Field is A0B.Types.SVD.UInt2;
   subtype MATRIX_PRAS_M2PR_Field is A0B.Types.SVD.UInt2;
   subtype MATRIX_PRAS_M3PR_Field is A0B.Types.SVD.UInt2;
   subtype MATRIX_PRAS_M4PR_Field is A0B.Types.SVD.UInt2;
   subtype MATRIX_PRAS_M5PR_Field is A0B.Types.SVD.UInt2;
   ...
   type MATRIX_MRCR_RCB_Field_Array is array (0 .. 3) of Boolean
   ...
   subtype MATRIX_MRCR_RCB4_Field is A0B.Types.SVD.UInt2;
   ...
   type CCFG_SYSIO_Register is record
      --  unspecified
      Reserved_0_11  : A0B.Types.SVD.UInt12 := 16#0#;
   ...
   subtype MATRIX_WPMR_WPKEY_Field is A0B.Types.SVD.UInt24;
   ...
   subtype MATRIX_WPSR_WPVSRC_Field is A0B.Types.SVD.UInt16;
