...
package A0B.ATSAM3X8E.SVD.EFC is
   pragma Preelaborate;
   ...
   subtype EFC0_FMR_FWS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype EFC0_FCR_FARG_Field is A0B.Types.SVD.UInt16;
...
--  no action is started.
   ...
   type EFC0_FCR_Register is record
      ...
      FCMD : FCR_FCMD_Field := A0B.ATSAM3X8E.SVD.EFC.GETD;
   ...
   type EFC_Peripheral is record
      ...
      FRR : aliased A0B.Types.SVD.UInt32;
   end record
     with Volatile;
