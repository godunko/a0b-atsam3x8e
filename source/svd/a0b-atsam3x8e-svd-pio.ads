...
package A0B.ATSAM3X8E.SVD.PIO is
   pragma Preelaborate;
   ...
   --  PIOA_ABSR_P array
   type PIOA_ABSR_P_Field_Array is array (0 .. 31) of Boolean
     with Component_Size => 1, Size => 32;
   ...
   --  PIOA_SCIFSR_P array
   type PIOA_SCIFSR_P_Field_Array is array (0 .. 31) of Boolean
     with Component_Size => 1, Size => 32;
   ...
   --  PIOA_DIFSR_P array
   type PIOA_DIFSR_P_Field_Array is array (0 .. 31) of Boolean
     with Component_Size => 1, Size => 32;
   ...
   --  PIOA_IFDGSR_P array
   type PIOA_IFDGSR_P_Field_Array is array (0 .. 31) of Boolean
     with Component_Size => 1, Size => 32;
   ...
   subtype PIOA_SCDR_DIV_Field is A0B.Types.SVD.UInt14;
   ...
   subtype PIOA_WPMR_WPKEY_Field is A0B.Types.SVD.UInt24;
   ...
   subtype PIOA_WPSR_WPVSRC_Field is A0B.Types.SVD.UInt16;
