...
package body A0B.ATSAM3X8E.Startup_Utilities is
   ...
   begin
      ...
      EFC0_Periph.FMR.FWS := A0B.Types.Unsigned_4 (FLASH_WAIT_STATE);
      EFC1_Periph.FMR.FWS := A0B.Types.Unsigned_4 (FLASH_WAIT_STATE);
      ...
      PMC_Periph.CKGR_PLLAR :=
        (ONE       => True,
         MULA      => A0B.Types.Unsigned_11 (MUL - 1),
         DIVA      => A0B.Types.Unsigned_8 (DIV),
         PLLACOUNT => 16#3F#,
         others    => <>);
